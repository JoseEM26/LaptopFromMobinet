								...
								<div class="login-form">
									...
									<form action="login" method="post">
										<input type="email" placeholder="Correo" id="correoLogin"
											name="correo" required> <input type="password"
											placeholder="Contraseña" id="contrasenaLogin" name="clave"
											required>
							...
							<div class="register-panel">
								...
								<div class="register-form">
									...
									<form action="registro" method="post">
										...
										<input
											type="tel" placeholder="Número de Teléfono" id="telefono"
											name="telefono" required pattern="[0-9]{9}"> 
										<input
