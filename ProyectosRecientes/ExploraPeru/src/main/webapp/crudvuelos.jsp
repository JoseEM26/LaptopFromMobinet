			...
			<div class="row">
				<div class="col">
					...
					<form class="row g-3" action="crudvuelos" method="post">
						<div class="col-12">
							<label for="inputIdVuelo" class="form-label">ID de Vuelo</label>
							<input name="idVuelo" maxlength="5"
								required="required" type="text" class="form-control"
								id="inputIdVuelo" placeholder="id">
						</div>
						<div class="col-12">
							<label for="inputLugar" class="form-label">Lugar</label> <input
								name="lugar" type="text" class="form-control" id="inputLugar"
