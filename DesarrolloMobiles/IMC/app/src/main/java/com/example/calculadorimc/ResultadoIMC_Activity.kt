...
import com.example.calculadorimc.databinding.ActivityResultadoImcBinding

class ResultadoIMC_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.reinicar.setOnClickListener{finish()}
    }
}